...
Начиная с `1.20.9` idle-пауза применяется только когда нет полезной работы, а драйвер мыши за один poll вычитывает больше PS/2-байтов — это заметно уменьшает лаг курсора и задержку кликов на `virtio-vga-gl`.
