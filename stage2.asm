...
ALIGN 16
vbe_mode_candidates:
    ; На части конфигураций QEMU/virtio-vga-gl список VBE-режимов отличается:
    ; некоторые хосты не дают 0x118, но корректно отдают 640x480/800x600.
    ; Идём от более «широких» режимов к гарантированным fallback-вариантам.
    dw 0x11B ; 1280x1024x32
    dw 0x11A ; 1280x1024x16
